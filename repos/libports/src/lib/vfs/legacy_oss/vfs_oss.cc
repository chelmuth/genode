	...
	public:
		...
		struct Info
		{
			...
			void print(Genode::Output &out) const
			{
				...
				(void)Genode::Generator::generate({ buf, sizeof(buf) }, "oss",
					[&] (Genode::Generator &g) {
...
struct Vfs_oss::File_system : Union_file_system, Vfs::File_system::Factory
{
	...
	Readonly_value_file_system<unsigned>  _sample_rate_fs       { *this, "sample_rate", 0U };
